ffmpeg -y -loglevel error -i c_a.mp4 -i c_b.mp4 -i c_c.mp4 -i c_d.mp4 -i c_e.mp4 -filter_complex "
  ...
  [v2][3:v]xfade=transition=fade:duration=0.35:offset=20.45[v3];
  [v3][4:v]xfade=transition=fade:duration=0.35:offset=29.1,format=yuv420p[vout]
" -map "[vout]" -c:v libx264 -preset veryfast -crf 20 -r 30 video_xf.mp4
echo VIDEO_TOTAL=37.9
