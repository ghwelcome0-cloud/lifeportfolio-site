...
# -*- coding: utf-8 -*-
"""
인생포트폴리오 맞춤형 다이어리 v1.4 — 표지 후가공 위치 가이드 (Layout Diagram)
─────────────────────────────────────────────────────────────────────────
...
- 형압 영역 (사용 시: L 모노그램 — v1.3에서 제거되었으므로 본 가이드에서는 옵션 처리)
- 도련 3mm 가이드
...
<h1>표지 후가공 위치 가이드 — Cover Layout Diagram (v1.4)</h1>
<div class="subtitle">인생포트폴리오 맞춤형 다이어리 · A5 · 256p · 70g · Undated 만년형 · 도련 3mm · 2도 (Navy + Gold)</div>
...
<div class="legend">
    ...
    <table class="dim-table">
        ...
        <tr><td>배경 Navy</td><td>#1B2A4A · R27 G42 B74</td><td>C100 M85 Y45 K40</td><td>PANTONE 2767 C</td></tr>
        <tr><td>금박 Gold</td><td>#C9A04F · R201 G160 B79</td><td>C20 M35 Y75 K15</td><td>PANTONE 871 C (Metallic) 또는 7563 C (Coated)</td></tr>
    </table>

    <p style="margin-top:5mm;"><strong>■ 후가공 위치</strong> (★ = 필수)</p>
    <table class="dim-table">
        <tr><th>위치</th><th>가공</th><th>좌표 (앞표지 trim 기준, mm)</th><th>크기 (mm)</th></tr>
        <tr><td>★ LIFE PORTFOLIO</td><td>금박 박표지</td><td>top 76, left 20</td><td>114 × 14</td></tr>
        <tr><td>인생포트폴리오 맞춤형 다이어리</td><td>금박 박표지 (소형)</td><td>top 94, left 28</td><td>98 × 10</td></tr>
        <tr><td>UNDATED · 만년형</td><td>금박 박표지 (대조 옅음)</td><td>top 170, left 40</td><td>74 × 7</td></tr>
        <tr><td>★ ONLY ONE</td><td>금박 박표지 (강조)</td><td>top 184, left 35</td><td>84 × 9</td></tr>
        <tr><td>책등 LIFE PORTFOLIO</td><td>금박 박표지 (세로)</td><td>spine, top 80</td><td>20 × 56</td></tr>
        <tr><td>뒤표지 카피</td><td>금박 박표지 (제한적)</td><td>top 70, center</td><td>124 × 60</td></tr>
    </table>
    ...
    <ul style="font-size:8pt; line-height:1.7; padding-left:6mm;">
        <li>표지 재질: PU(Polyurethane) 양장 — Navy #1B2A4A 무광</li>
        <li>제본: 사철 (Smyth-Sewn) + PUR 풀제본</li>
        <li>책등 라운드: 옵션 (제조사 권장)</li>
        <li>가름끈: 2개 (Gold + Navy, 220 mm)</li>
