...
# -*- coding: utf-8 -*-
"""
인생포트폴리오 다이어리 v1.4 — 색상 스워치 PDF + colors.txt
─────────────────────────────────────────────────────────
출력:
...
# colors.txt — 텍스트 사양서
# ─────────────────────────────────────────────
COLORS_TXT = """인생포트폴리오 맞춤형 다이어리 v1.4 — 색상 사양
=====================================================

본 다이어리는 2도 인쇄 (Navy + Gold)를 사용합니다.

──────────────────────────────────────────
[1] NAVY (메인 컬러 · 표지·간지·헤더·키 텍스트)
──────────────────────────────────────────
이름     · LIFE PORTFOLIO NAVY
HEX      · #1B2A4A
RGB      · R 27   G 42   B 74
CMYK     · C 100  M 85   Y 45   K 40        (참고치 — 제조사 ICC 프로파일에 따라 보정)
Pantone  · PANTONE 2767 C        (Solid Coated)
            또는 PANTONE 539 C   (대안, 약간 더 어두움)
...
인쇄 사양 권장 사항
──────────────────────────────────────────
- 본문 인쇄: 2도 (Navy + Gold) 권장. 흑백 단도(K)도 가능.
- 표지 금박: 박지(Foil Stamp) — Pantone 871 C 또는 동등품
- 표지 형압(Emboss/Deboss): 옵션 — 'L' 모노그램은 v1.3에서 제거됨
...
제조사는 자체 RIP/Preflight 워크플로우에서:
  ...
  2) RGB → CMYK 변환
  3) 폰트 임베드 확인 (Noto Sans/Serif CJK KR — 이미 임베드됨)
  4) 도련 3mm 확인 (이미 적용됨)
순으로 처리 후 출력하시면 됩니다.
...
<html lang="ko"><head><meta charset="UTF-8"><title>색상 스워치 · v1.4</title>
<style>""" + SWATCH_CSS + """</style></head>
<body>

<h1>색상 사양 — Color Swatch (v1.4)</h1>
<div class="subtitle">인생포트폴리오 맞춤형 다이어리 · 2도 인쇄 (Navy + Gold) · 2026-05-20</div>

<div class="swatch-row">
    <div class="swatch-block">
        <div class="swatch-color" style="background: #1B2A4A;"></div>
        <div class="swatch-info">
            <h2>LIFE PORTFOLIO NAVY</h2>
            <table>
                <tr><td class="k">HEX</td><td class="v">#1B2A4A</td></tr>
                <tr><td class="k">RGB</td><td class="v">R 27 · G 42 · B 74</td></tr>
                <tr><td class="k">CMYK</td><td class="v">C 100 · M 85 · Y 45 · K 40</td></tr>
                <tr><td class="k">Pantone</td><td class="v">PANTONE 2767 C</td></tr>
...
<div class="footer-note">
    ...
    ※ ICC 프로파일 권장: Japan Color 2001 Coated 또는 ISO Coated v2 (FOGRA39 기반).
</div>
