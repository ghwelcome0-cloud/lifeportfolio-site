...
S.render.filepath = '/home/user/lf/r3d/_pv4/k_'
t = time.time(); bpy.ops.render.render(animation=True); el = time.time() - t
print("PREVIZ4 %d frames  %.1fs  (%.3f s/frame)  setup %.1fs"
