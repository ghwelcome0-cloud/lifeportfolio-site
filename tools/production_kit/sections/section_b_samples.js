...
module.exports = function renderSectionB(data){
  ...
  const intro = [
    ...
    '  <p class="section-lede">동일 엔진(v4.1)에 톤별 대표 응답 시나리오를 투입한 결과입니다. 4축 점수, Mission/Vision 헤드라인(응답 직합성), 강점·진로·교육 추천이 톤마다 어떻게 결을 달리하는지 비교하실 수 있도록 압축형 1톤=1페이지 레이아웃으로 정리했습니다.</p>',
