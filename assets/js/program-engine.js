...
(function (root, factory) {
  ...
  var L3_WEEK_ACTION_KO = {
    ...
    principled_designer: {
      ...
      "관계지향": [
        ["매일 아침, 오늘 사람과 지킬 약속 하나를 한 줄로 적습니다.","사람을 대할 때 내 기준을 잘 지켰는지 한 번 메모합니다.","하루 끝에, 사람 곁에서 기준을 지킨 한 장면을 세 줄로 적습니다."],
        ["주 3회, 내가 중요하게 여기는 것을 한 사람에게 말해 봅니다.","가까운 사람과의 약속 하나를 점검합니다.","같은 마음을 가진 사람 1명에게 짧은 메시지를 보냅니다."],
        ["오래 함께한 사람과 30분 깊은 대화를 나눕니다.","지난 3주 사람 곁에서 지킨 것 3가지를 적습니다.","다음 달에 함께 지킬 약속 하나를 정해 둡니다."]
      ],
      "성장지향": [
    ...
    visionary_creator: {
      ...
      "관계지향": [
        ["매일 아침, 오늘 만들 것에 담을 사람의 마음 하나를 적습니다.","대화에서 사람들이 진짜 원하는 것 하나를 메모합니다.","하루 끝에, 사람의 마음이 담긴 한 장면을 세 줄로 적습니다."],
  ...
  function build(opts) {
    ...
    var monthGoalCustom = isEn
      ...
      : {
          title: "좋아하는 일(" + (_firstItem(userActivities) || "관심 활동") + ")에서 눈에 보이는 결과 하나 만들기",
          criterion: "3개월 끝에 '" + userTool1 + "' 같은 보람을 느낀 결과 3건 모으기"
        };
    ...
    var nsExtraY1 = isEn
      ...
      : (" — 채워질 힘 \u2018" + tpl(userWeakGrain, vars) + "\u2019이 받쳐 줍니다.");
    var nextSteps = isEn ? [
