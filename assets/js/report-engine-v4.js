...
(function (root, factory) {
  ...
  var INTRO_RESULT_KO = {
    ...
    "아름다움":[["숨은 빛","비춰 주"],["담아낼 순간","담아 주"],["빛나는 것","밝혀 주"],["가꿔 갈 것","가꿔 주"]],
    ...
    "작품":[["담아낼 순간","담아 주"],["숨은 빛","비춰 주"],["빛나는 것","밝혀 주"],["가꿔 갈 것","가꿔 주"]],
  ...
  var ES2_PLACE_KO = {
    "조용한 공간 (도서관, 독서실 등)":          { where:"소리가 잦아든 자리",     short:"조용한 자리",   guard:"알림을 끄고 한 가지만 펼쳐 두면" },
    "사람들과 함께 있는 공간 (카페, 사무실 등)":{ where:"사람의 기척이 있는 자리", short:"사람이 있는 자리", guard:"옆자리 소리를 배경음으로 두면" },
    "자연 속 장소 (공원, 바다, 산 등)":         { where:"하늘이 보이는 열린 자리", short:"바깥 자리",     guard:"걷다 떠오른 것을 바로 적어 두면" },
    "정돈된 실내 (정리된 내 방, 사무 공간)":    { where:"책상이 비워진 자리",     short:"정돈된 책상",   guard:"지금 쓰지 않을 것을 눈앞에서 치우면" },
    "새로운 장소 (카페 투어, 여행지 등)":       { where:"처음 앉아 보는 자리",   short:"낯선 자리",     guard:"낯선 자리에서 시작 한 줄만 먼저 쓰면" },
    "내 방이나 익숙한 공간":                    { where:"몸이 먼저 익은 자리",   short:"익숙한 자리",   guard:"늘 앉는 자리에 오늘 끝낼 하나만 올려 두면" },
    "음악이나 분위기가 있는 공간":              { where:"같은 소리가 흐르는 자리", short:"음악이 있는 자리", guard:"같은 곡을 반복해 켜 두면" }
  };
  // Q49 리듬(8) → 시간 좌표
  /*   ★ short 는 '부르는 이름'. CEO 가 지적한 "따로 떼어 둔 몰입 덩어리"(13자)의
   *     짧은 이름이 "몰입 시간"(5자)이다. 설명형 block 은 기존 문장이 계속 쓴다. */
  var ES2_RHYTHM_KO = {
    "아침에 일찍 시작하고 저녁에 일찍 마무리하는 루틴": { when:"하루가 밝아 오는 이른 시간", block:"아침의 첫 덩어리", short:"아침 시간" },
    "점심 이후 본격적인 활동이 시작되는 일정":          { when:"낮이 무르익는 오후 시간",   block:"점심 뒤 첫 덩어리", short:"오후 시간" },
    "밤이 되어야 집중력이 올라가는 생활":               { when:"주위가 조용해지는 늦은 시간", block:"밤의 첫 덩어리", short:"밤 시간" },
    "계획표에 따라 움직이는 하루":                      { when:"미리 적어 둔 시간",        block:"표에 적힌 다음 칸", short:"계획한 시간" },
    "내 기분이나 감정에 따라 유동적인 하루":            { when:"마음이 올라오는 시간",     block:"마음이 붙는 첫 덩어리", short:"마음이 붙는 시간" },
    "즉흥적으로 정해지는 유연한 하루":                  { when:"그날 열리는 빈 시간",      block:"지금 비어 있는 덩어리", short:"비어 있는 시간" },
    "일과 휴식이 반복되는 분산형 일정":                 { when:"일과 쉼이 번갈아 오는 시간", block:"짧게 끊은 한 덩어리", short:"짧게 끊은 시간" },
    "몰입 시간과 휴식 시간을 명확히 나누는 하루":       { when:"몰입으로 떼어 둔 시간",     block:"따로 떼어 둔 몰입 덩어리", short:"몰입 시간" }
  };
