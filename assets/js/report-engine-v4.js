...
(function (root, factory) {
  ...
  var TIER_AXIS_COMMENT_KO = {
    self_understanding: {
      deep:     "자신을 깊이 이해해, 남의 자기성찰까지 도울 수 있습니다.",
      active:   "자기 이해가 안정적으로 작동해, 외부 자극에 흔들리지 않습니다.",
      emerging: "자기 이해가 막 피어나는 때 — 성찰 일기·코칭 대화로 빨라집니다.",
      seed:     "자기 이해의 씨앗 단계 — 짧은 자기 응시 시간부터 시작해 보세요."
    },
    self_expression: {
      deep:     "감정과 생각을 안전하게 풀어내, 남의 감정 회복까지 돕습니다.",
      active:   "자기표현이 활발해, 더 큰 무대(글·강연·대화)로 넓힐 수 있습니다.",
      emerging: "자기표현이 막 피어나는 때 — 작은 글쓰기·1:1 대화로 단단해집니다.",
      seed:     "자기표현의 씨앗 단계 — 믿는 한 사람 앞에서 한 문장 말하기부터."
    },
    self_design: {
      deep:     "흐름과 단계를 스스로 짜서 결과로 옮길 수 있습니다.",
      active:   "자기설계가 활발해, 분기·연간 목표 운영이 가능합니다.",
      emerging: "자기설계가 막 피어나는 때 — 작은 주간 계획부터 키워 보세요.",
      seed:     "자기설계의 씨앗 단계 — 하루 1개 결정·1개 행동부터 시작해 보세요."
    },
    self_execution: {
      deep:     "약속한 결과를 끝까지 만들어냅니다.",
      active:   "자기실행이 활발해, 더 큰 약속(프로젝트·팀)으로 넓힐 수 있습니다.",
      emerging: "자기실행이 막 피어나는 때 — '작게 끝내기'를 반복하면 단단해집니다.",
      seed:     "자기실행의 씨앗 단계 — '오늘 끝낼 1개'를 정해 마무리하는 연습부터."
    }
  };
...
;
        ...
        if (isEn) {
          ...
          var eKo = {
            resource:  "일을 시작하는 순간, " + (dOpp ? (esStripDot(dOpp) + " — ") : "") + "여기서부터 힘이 나옵니다.",
            bridge:    "막히는 순간, " + esActNoun((finAct.action) || "한 번 검토하고 공유·전달로 닫습니다") + "이 당신의 생각을 사람에게 전합니다.",
            constraint:"밀어붙이는 대신, " + esActNoun((defAct.action) || "완료 기준과 첫 결과물을 정합니다") + "과 갖춘 환경이 마무리를 지켜 줍니다.",
            activation:"'" + esStripDot((capAct.doneWhen) || "이번 과제에 필요한 것들이 한 화면에 모여 있습니다") + "' — 이때 망설임이 첫 동작으로 바뀌고, 끝냈다는 증거가 남습니다."
          };
